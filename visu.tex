...
Here we describe a synthetic language that allow to indicate which information in a profile is displayed, where, and how, and to derive properties of those visualizations that indicate which kind of comparisons it permits. (TODO: get inspiration from \cref{sec:grib}.)
